...
public class Customers implements Serializable {
	...
	private byte[] propertyPhoto = "".getBytes();
	private byte[] ownerPhoto = "".getBytes();
	private byte[] occupantPhoto = "".getBytes();
	private String propertyPhotoBase;
	private String ownerPhotoBase;
	private String occupantPhotoBase;
	...
	private String statusLastReview = "2000-01-01";
	private String dateDisconnected = "2000-01-01";
	...
	public String getLastRecharged() {
		return lastRecharged;
	}

	public void setLastRecharged(String lastRecharged) {
	...
	public String getPropertyPhotoBase() {
		return propertyPhotoBase;
	}

	public void setPropertyPhotoBase(String propertyPhotoBase) {
		this.propertyPhotoBase = propertyPhotoBase;
	}

	public String getOwnerPhotoBase() {
		return ownerPhotoBase;
	}

	public void setOwnerPhotoBase(String ownerPhotoBase) {
		this.ownerPhotoBase = ownerPhotoBase;
	}

	public String getOccupantPhotoBase() {
		return occupantPhotoBase;
	}

	public void setOccupantPhotoBase(String occupantPhotoBase) {
		this.occupantPhotoBase = occupantPhotoBase;
	}
